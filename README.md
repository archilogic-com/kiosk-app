...
https://github.com/user-attachments/assets/e393993d-e60d-4951-a7a1-a68689a26e7d

**Live demo:** [archilogic-kiosk-demo.netlify.app](https://archilogic-kiosk-demo.netlify.app)
...
The code shows how the SDK's [queries](https://developers.archilogic.com/floor-plan-engine/guide.html#queries), [theming](https://developers.archilogic.com/floor-plan-engine/guide.html#theme), [markers](https://developers.archilogic.com/floor-plan-engine/guide.html#markers), [drawing layers](https://developers.archilogic.com/floor-plan-engine/guide.html#drawing) and [wayfinding](https://developers.archilogic.com/floor-plan-engine/guide.html#wayfinding) work together in a complete app. The [API reference](https://developers.archilogic.com/floor-plan-engine/api.html) documents every call it makes.
...
- **[Wayfinding](https://developers.archilogic.com/floor-plan-engine/guide.html#wayfinding)** from the kiosk to any space or workstation, with the distance, walking time and turn-by-turn directions
...
- **Theme editor** built on the SDK's [theme API](https://developers.archilogic.com/floor-plan-engine/guide.html#theme), with four presets
...
Each file in `floor-plan/` follows a section of the [SDK guide](https://developers.archilogic.com/floor-plan-engine/guide.html):

| File            | SDK guide                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `engine.ts`     | [Quick start](https://developers.archilogic.com/floor-plan-engine/guide.html#quick-start), [Queries](https://developers.archilogic.com/floor-plan-engine/guide.html#queries), [Events](https://developers.archilogic.com/floor-plan-engine/guide.html#events), [Zoom](https://developers.archilogic.com/floor-plan-engine/guide.html#zoom), [Save floor plan as image](https://developers.archilogic.com/floor-plan-engine/guide.html#save-floor-plan-as-image) |
| `theme.ts`      | [Theme](https://developers.archilogic.com/floor-plan-engine/guide.html#theme), [Visibility](https://developers.archilogic.com/floor-plan-engine/guide.html#visibility)                                                                                                                                                                                                                                                                                          |
| `highlights.ts` | [Highlight a resource](https://developers.archilogic.com/floor-plan-engine/guide.html#highlight-a-resource)                                                                                                                                                                                                                                                                                                                                                     |
| `wayfinding.ts` | [Wayfinding](https://developers.archilogic.com/floor-plan-engine/guide.html#wayfinding), [Add layer and graphics](https://developers.archilogic.com/floor-plan-engine/guide.html#add-layer-and-graphics)                                                                                                                                                                                                                                                        |
| `markers.ts`    | [Add Html marker](https://developers.archilogic.com/floor-plan-engine/guide.html#add-html-marker)                                                                                                                                                                                                                                                                                                                                                               |

### Drawing the plan

`Kiosk.tsx` makes the only [`floorPlan.set({ theme, visibility })`](https://developers.archilogic.com/floor-plan-engine/api.html#update-settings) call, and `floorPlanStyle` always builds the full [theme](https://developers.archilogic.com/floor-plan-engine/guide.html#theme). The engine merges each new theme with its own defaults, so a partial theme would lose everything it leaves out. Hidden element types, furniture and labels use the SDK's [`visibility`](https://developers.archilogic.com/floor-plan-engine/guide.html#visibility) option.

`computeHighlights` turns every highlight (hover, selection, category filters, search results, the dashboard's events and the route's destination) into one list of [node styles](https://developers.archilogic.com/floor-plan-engine/guide.html#highlight-a-resource). Nothing paints the plan directly, so clearing a highlight never means restoring an old colour.

## SDK version

Wayfinding uses [`floorPlan.getPath({ start, end })`](https://developers.archilogic.com/floor-plan-engine/guide.html#get-path), available from `@archilogic/floor-plan-sdk` [5.5.0](https://developers.archilogic.com/floor-plan-engine/changelog.html#v5-5-0). The SDK loads its pathfinding engine on demand the first time a route is requested.
