...
/** In °C, matching the metric units of the plan and the routes. */
export const MOCK_WEATHER = {
  location: 'Asheville, NC',
  currentTempC: 8,
  condition: 'partly-cloudy',
  hourly: [
    { hoursAhead: 1, tempC: 7, condition: 'partly-cloudy' },
    { hoursAhead: 2, tempC: 6, condition: 'cloudy' },
    { hoursAhead: 3, tempC: 4, condition: 'cloudy' },
    { hoursAhead: 4, tempC: 3, condition: 'rainy' },
  ],
} as const
