 ...
 * layout, with everything the floor will fill in shimmering, and a quiet
 * note of progress where the plan is about to appear.
 */
  ...
  return (
    ...
    >
      ...
      <div
        ...
        aria-hidden="true"
      >
        <div className="flex animate-in items-center gap-3 text-xs text-muted-foreground/70 delay-300 duration-500 fade-in fill-mode-backwards">
