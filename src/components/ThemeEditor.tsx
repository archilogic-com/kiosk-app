    ...
    <div className="space-y-1 pt-1">
      ...
      <div className="border-t border-border/20 px-2 pt-2">
        ...
        <div className="flex items-center gap-2 px-2 py-1">
          <span className="min-w-0 flex-1 text-xs">Text color</span>
          <ColorSwatch
        ...
        <div className="flex items-center gap-2 px-2 py-1">
          <span className="min-w-0 flex-1 text-xs">Text outline</span>
          <button
            role="switch"
      ...
      <div className="border-t border-border/20 pt-1">
        <button
          ...
          className="flex w-full items-center gap-1.5 px-2 py-1 text-xs font-semibold text-muted-foreground transition-colors hover:text-foreground"
        >
          <ChevronRight
          ...
          >
            {ELEMENT_GROUPS.map(({ label, keys }) => (
              <Accordion.Item key={label} value={label}>
                <Accordion.Header>
                  <Accordion.Trigger className="group flex w-full items-center gap-1.5 rounded px-2 py-1 text-xs font-semibold text-muted-foreground transition-colors hover:bg-accent">
                    <ChevronRight
                ...
                <Accordion.Content className="overflow-hidden data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down">
                  <div className="pb-1">
                    <div className="flex items-center gap-1.5 px-2 py-0.5 text-center text-xs text-muted-foreground">
