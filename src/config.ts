...
const DEMO_CONFIG: FloorPlanConfig = {
  publishableAccessToken: 'aff5a7da-b0fa-4a4a-bb1d-61494c6ea812',
  target: { kind: 'layout', id: '18ba1e14-680f-4ab3-b8be-6d243c6bbe17' },
  workstationAttributes: {
...
/**
 * Screen layout shared between the CSS, the panels and the zoom maths.
 *
...
/** The part of the screen the panels leave visible, for framing the plan. */
 ...
 * last of the five staggered dashboard panels: `.dashboard-exit` runs 250ms
 * after a `stagger-index * 40ms` delay.
 */
export const EXIT_ANIMATION_MS = 250 + 4 * 40
